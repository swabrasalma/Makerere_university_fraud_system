		...
		<div id="body">
			<div class="header">
				<div>
					...
					<ul>
						<!-- <p>The initial array before turned into stack</p> -->
			  <a href='stack_view.php?linked=create' class='list-group-item'><h3>Generate stack</h3> </a></li>
				  <a href="stack_view.php?linked=push" class='list-group-item'><h3>Push</h3> </a>
				   <a href="stack_view.php?linked=pop" class='list-group-item'><h3>Pop</h3> </a>
				    <a href="stack_view.php?linked=getlist" class='list-group-item'><h3>Display Stack</h3> </a>
