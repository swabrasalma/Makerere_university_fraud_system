...
<div id="page">
			...
			<div>
				<ul id="navigation">
					...
					<li class="menu">
						...
						<ul class="primary">
							<li>
								<a href="arrays.php">List arrays</a>
							</li>
							<li>
								<a href="stacks.php">Stack arrays</a>
							</li>
							<li>
								<a href="queues.php">Queue arrays</a>
							</li>
						</ul>
					</li>
					<li class="menu">
		...
		<ul class="primary">
               <li><a href="#">Heap</a></li>
               <li><a href="sort.php?algorithm=heapsort">Heap sort</a></li>
            </ul>
		</li> 
		<li class ="menu">
    ...
    <form for='form' class='form-inline' method='post' id='upload_form'  action='insertion.php' enctype='multipart/form-data'>             
               
    <p>Please click the sort button to sort the generated array</p>
    <p><input type="submit" value="Insertion Sort" name="insertionsubmit" id="submit"></p>
      </form>
 </br></br>
      		<p>
...
on the subarrays would be appropriate.				  </p>
	...
	include("system_functions.php");
		if (isset($_POST['insertionsubmit'])) {
			$timeUsed = microtime();
			$data = getArray();
