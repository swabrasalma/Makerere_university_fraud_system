...
<div id="page">
    ...
    <form for='form' class='form-inline' method='post' id='upload_form'  action='merge.php' enctype='multipart/form-data'>             
               
    <p>Please click the sort button to sort the generated array</p>
    <p><input type="submit" value="Merge Sort" name="mergesubmit" id="submit"></p>
      </form>
 </br></br>
      		<p>
